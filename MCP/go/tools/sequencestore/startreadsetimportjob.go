...
func StartreadsetimportjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/sequencestore/%s/importjob", cfg.BaseURL, sequenceStoreId)
		...
		var result models.StartReadSetImportJobResponse
...
func CreateStartreadsetimportjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_sequencestore_sequenceStoreId_importjob",
		mcp.WithDescription("Starts a read set import job."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    StartreadsetimportjobHandler(cfg),
	}
}
