# Amazon Omics MCP Server

This MCP (Model Content Protocol) server provides access to Amazon Omics API functionality through HTTP, HTTPS, and STDIO transport modes.
